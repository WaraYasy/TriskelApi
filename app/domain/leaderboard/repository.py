...
class LeaderboardRepository:
    ...
    def get_by_type(self, leaderboard_type: LeaderboardType) -> Optional[Leaderboard]:
        ...
        Args:
            leaderboard_type: Tipo de leaderboard

        Returns:
            Leaderboard o None si no existe
        """
    ...
    def get_all(self) -> List[Leaderboard]:
        ...
        Returns:
            Lista de todos los leaderboards
        """
    ...
    def save(self, leaderboard: Leaderboard) -> Leaderboard:
        ...
        Args:
            leaderboard: Leaderboard a guardar
    ...
    def initialize_all(self) -> None:
        """
        Inicializa todos los leaderboards vacios si no existen.

        Util para el primer despliegue.
        """
