...
function toggleTheme() {
    ...
    if (toggleBtn) {
        toggleBtn.setAttribute('title', newTheme === 'dark' ? 'Cambiar a modo claro' : 'Cambiar a modo oscuro');
    }
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const toggleBtn = document.querySelector('.theme-toggle');
    if (toggleBtn) {
        toggleBtn.setAttribute('title', savedTheme === 'dark' ? 'Cambiar a modo claro' : 'Cambiar a modo oscuro');
    }
});
