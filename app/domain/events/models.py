...
class GameEvent(BaseModel):
    ...
    Attributes:
        event_id: ID único del evento (UUID)
        game_id: ID de la partida donde ocurrió
        player_id: ID del jugador que generó el evento
        timestamp: Momento exacto del evento (UTC)
        event_type: Tipo de evento (ver tipos soportados arriba)
